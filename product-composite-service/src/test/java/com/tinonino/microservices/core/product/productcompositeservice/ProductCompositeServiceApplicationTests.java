...
class ProductCompositeServiceApplicationTests {
	...
	void setUp() {
		...
		when(productFacade.getProduct(PRODUCT_ID_NOT_FOUND))
				.thenThrow(new ProductNotFoundException("NOT FOUND: " + PRODUCT_ID_NOT_FOUND));

		when(productFacade.getProduct(PRODUCT_ID_INVALID))
